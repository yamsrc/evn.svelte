...
<Section class="py-8">
  <div class="max-w-none">
    ...
    <section class="mb-8">
      ...
      <p class="mb-4">
        Welcome to Evnly ("we", "our", or "us"). We are committed to protecting your personal
        information and your right to privacy. This Privacy Policy explains how we collect, use,
        disclose, and safeguard your information when you use our expense splitting application.
      </p>
      <p class="mb-4">
    ...
    <section class="mb-8">
      ...
      <p class="mb-4">
        When you register for an account, we may collect personal information including but not
        limited to:
      </p>
      ...
      <h3 class="text-xl font-semibold mb-3">User-Generated Content</h3>
      <p class="mb-4">
        We collect content that you create, upload, or share through our services, including:
      </p>
      <ul class="list-disc pl-6 mb-4 space-y-2">
        <li>Receipt photos and images you upload</li>
        <li>Photos added to your account</li>
        <li>Expense details and descriptions</li>
        <li>Comments and notes</li>
        <li>Group and contact information</li>
      </ul>

      <h3 class="text-xl font-semibold mb-3">Usage Data</h3>
      <p class="mb-4">We automatically collect certain information when you use our application:</p>
      <ul class="list-disc pl-6 mb-4 space-y-2">
    ...
    <section class="mb-8">
      ...
      <ul class="list-disc pl-6 mb-4 space-y-2">
        ...
        <li>Process and manage your expenses and groups</li>
        <li>Enable you to share expenses with your contacts</li>
    ...
    <section class="mb-8">
      <h2 class="text-2xl font-semibold mb-4">How We Share Your Information</h2>
      <p class="mb-4">We may share your information in the following situations:</p>
      <ul class="list-disc pl-6 mb-4 space-y-2">
        <li>
          <strong>With other users:</strong>
          When you share expenses or create groups, the relevant information is shared with the members
          you've selected
        </li>
        <li>
    ...
    <section class="mb-8">
      ...
      <p class="mb-4">
        Your uploaded photos (receipts and account images) are stored securely and are only
        accessible to you and users with whom you've explicitly chosen to share them.
      </p>
    </section>
    ...
    <section class="mb-8">
      ...
      <p class="mb-4">
        ...
        your country. We take appropriate safeguards to ensure that your personal information
    ...
    <section class="mb-8">
      ...
      <p class="mb-4">
        Email: <a href="mailto:apps@seed.me" class="text-primary hover:underline">apps@seed.me</a>
      </p>
    </section>
  </div>
</Section>
