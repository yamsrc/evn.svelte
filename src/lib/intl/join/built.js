  ...
  "ar-SA": {
    ...
    "receipts": {
      ...
      "dialog": {
        "join": "انضمام",
        "decline": "رفض",
        "title": "دعوة إلى الفاتورة",
        "description": (name, gender) => {
  if (gender === "he") return `${name} يرغب في إضافتك إلى الفاتورة.`;
  if (gender === "she") return `${name} ترغب في إضافتك إلى الفاتورة.`;
  return `${name} يرغب(ترغب) في إضافتك إلى الفاتورة.`;
}
      }
    }
  },
  "de-DE": {
    ...
    "receipts": {
      ...
      "dialog": {
        "join": "Beitreten",
        "decline": "Ablehnen",
        "title": "Einladung zur Rechnung",
        "description": (name, gender) => {
  return `${name} möchte dich zur Rechnung hinzufügen.`;
}
      }
    }
  },
  "en-US": {
    ...
    "receipts": {
      ...
      "dialog": {
        "join": "Join",
        "decline": "Decline",
        "title": "Invitation to the check",
        "description": (name, gender) => {
  return `${name} would like to add you to the check.`;
}
      }
    }
  },
  "es-ES": {
    ...
    "receipts": {
      ...
      "dialog": {
        "join": "Unirse",
        "decline": "Rechazar",
        "title": "Invitación a la cuenta",
        "description": (name, gender) => {
  if (gender === "he") return `${name} quiere agregarte a la cuenta.`;
  if (gender === "she") return `${name} quiere agregarte a la cuenta.`;
  return `${name} quiere agregarte a la cuenta.`;
}
      }
    }
  },
  "fr-FR": {
    ...
    "receipts": {
      ...
      "dialog": {
        "join": "Rejoindre",
        "decline": "Refuser",
        "title": "Invitation à l’addition",
        "description": (name, gender) => {
  if (gender === "he") return `${name} souhaite t'ajouter à l'addition.`;
  if (gender === "she") return `${name} souhaite t'ajouter à l'addition.`;
  return `${name} souhaite t'ajouter à l'addition.`;
}
      }
    }
  },
  "hi-IN": {
    ...
    "receipts": {
      ...
      "dialog": {
        ...
        "title": "बिल के लिए निमंत्रण",
        "description": (name, gender) => {
  if (gender === "he") return `${name} आपको बिल में जोड़ना चाहता है।`;
  if (gender === "she") return `${name} आपको बिल में जोड़ना चाहती है।`;
  return `${name} आपको बिल में जोड़ना चाहता/चाहती है।`;
}
      }
    }
  },
  "it-IT": {
    ...
    "receipts": {
      ...
      "dialog": {
        "join": "Unisciti",
        "decline": "Rifiuta",
        "title": "Invito al conto",
        "description": (name, gender) => {
  return `${name} vorrebbe aggiungerti al conto.`;
}
      }
    }
  },
  "ja-JP": {
    ...
    "receipts": {
      ...
      "dialog": {
        ...
        "title": "会計へのご案内",
        "description": (name, gender) => {
  return `${name} さんがあなたをお会計に追加したいと考えています。`;
}
      }
    }
  },
  "ko-KR": {
    ...
    "receipts": {
      ...
      "dialog": {
        ...
        "title": "계산서 요청 안내",
        "description": (name, gender) => {
  return `${name}님이 당신을 계산서에 추가하고 싶어합니다.`;
}
      }
    }
  },
  "nl-NL": {
    ...
    "receipts": {
      ...
      "dialog": {
        "join": "Meedoen",
        "decline": "Weigeren",
        "title": "Uitnodiging voor de rekening",
        "description": (name, gender) => {
  return `${name} wil je toevoegen aan de rekening.`;
}
      }
    }
  },
  "ru-RU": {
    ...
    "receipts": {
      ...
      "dialog": {
        "join": "Присоединиться",
        "decline": "Отклонить",
        "title": "Приглашение к счету",
        "description": (name, gender) => {
  if (gender === "he") return `${name} хочет добавить вас к счёту.`;
  if (gender === "she") return `${name} хочет добавить вас к счёту.`;
  return `${name} хочет(хочет) добавить вас к счёту.`;
}
      }
    }
  },
  "sw-TZ": {
    ...
    "receipts": {
      ...
      "dialog": {
        "join": "Jiunge",
        "decline": "Kataa",
        "title": "Mwaliko wa bili",
        "description": (name, gender) => {
  return `${name} angependa kukuongeza kwenye bili.`;
}
      }
    }
  },
  "tr-TR": {
    ...
    "receipts": {
      ...
      "dialog": {
        ...
        "title": "Hesaba davet",
        "description": (name, gender) => {
  return `${name} sizi hesaba eklemek istiyor.`;
}
      }
    }
  },
  "uk-UA": {
    ...
    "receipts": {
      ...
      "dialog": {
        "join": "Приєднатися",
        "decline": "Відхилити",
        "title": "Запрошення до рахунку",
        "description": (name, gender) => {
  if (gender === "he") return `${name} хоче додати вас до рахунку.`;
  if (gender === "she") return `${name} хоче додати вас до рахунку.`;
  return `${name} хоче додати вас до рахунку.`;
}
      }
    }
  },
